...
void Neight::on_pushButton_clicked()
{
    emit ChangeUislot20();
}

void Neight::keyPressEvent(QKeyEvent* event)
{
    if (!state) {
        return;
    }
...
void Neight::paintEvent(QPaintEvent*)
{
    QPainter p(this);
    p.setBrush(Qt::red);
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                ...
                if (s[i][j] == 0) {
                    ...
                    p.drawRect(i * 65 + 40, j * 65 + 140, 60,60);
                }
                else if (s[i][j] == 2) {
                    ...
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(2), QTextOption(Qt::AlignCenter));
                }
                else if (s[i][j] == 4) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(4), QTextOption(Qt::AlignCenter));
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(8), QTextOption(Qt::AlignCenter));
                }
                else if (s[i][j] == 16) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(16), QTextOption(Qt::AlignCenter));                }
                else if (s[i][j] == 32) {
                    p.setBrush(QColor(100, 149, 237));
                    p.drawRect(i * 65 + 40, j * 65 + 140, 60,60);
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(32), QTextOption(Qt::AlignCenter));
                    }
                else if (s[i][j] == 64) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(64), QTextOption(Qt::AlignCenter));
                    }
                else if (s[i][j] == 128) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(128), QTextOption(Qt::AlignCenter));
                   }
                else if (s[i][j] == 256) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(256), QTextOption(Qt::AlignCenter));
                   }
                else if (s[i][j] == 512) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(512), QTextOption(Qt::AlignCenter));
                    }
                else if (s[i][j] == 1024) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(1024), QTextOption(Qt::AlignCenter));
                    }
                else if (s[i][j] == 2048) {
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(2048), QTextOption(Qt::AlignCenter));
                    ...
                    p.setPen(Qt::white);
                    p.setFont(QFont("微软雅黑", 20, 700, false));
                    p.drawText(QRectF(i * 65 + 40, j * 65 + 140, 60,60), QString::number(s[i][j]), QTextOption(Qt::AlignCenter));
                }
            }
        }
        int max,i,j;
        max=s[0][0];//让第一个数默认为最大数，后边的数依次比较即可！
        for(i=0;i<8;++i)//将数组中的数据一一取出进行比较！
         for(j=0;j<8;++j)
         {
    ...
    case 1:
        ...
        for(i1=0;i1<8;++i1)//将数组中的数据一一取出进行比较！
         for(j1=0;j1<8;++j1)
         {
    ...
    case 2:
        ...
        int max2,i2,j2;
                ...
                for(i2=0;i2<8;++i2)//将数组中的数据一一取出进行比较！
                 for(j2=0;j2<8;++j2)
                 {
    ...
    case 3:
        ...
        int max3,i3,j3;
                ...
                for(i3=0;i3<8;++i3)//将数组中的数据一一取出进行比较！
                 for(j3=0;j3<8;++j3)
                 {
