...
QT_MOC_LITERAL(1, 10, 13), // "ChangeUiSlot2"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 21) // "on_pushButton_clicked"

    },
    "Introduce\0ChangeUiSlot2\0\0on_pushButton_clicked"
};
...
void Introduce::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Introduce *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Introduce::ChangeUiSlot2)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Introduce::staticMetaObject = { {
    ...
    qt_meta_stringdata_Introduce.data,
